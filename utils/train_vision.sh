...
python3 train.py --batch-size 26 --data ../../utils/dataset.yaml --img-size 608 608 --cfg ../../utils/model.yaml --hyp ../../utils/hyp.yaml --weights yolov5m.pt
#--cache-images

# Test model.
python3 detect.py --source ../../image/ --output ../../image/result --weights runs/exp0/weights/best.pt --conf 0.4
#--cache-images
